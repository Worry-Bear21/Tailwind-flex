    ...
    <div class=" w-[350px] p-5 rounded-sm shadow-lg border border-gray-100" style="background-color: #1a202c;">
        <div class="flex gap-4 mb-4">
            ...
            <div class="text-sm text-gray-200 cursor-pointer  space-y-1">
                <svg @click="confirmAndClose" xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" width="25" height="25"
                    viewBox="0 0 24 24" class="flex ml-70">
                ...
                =======
                <div class="w-[260px] p-5 rounded-sm shadow-lg border border-gray-700"
                    ...
                    <div class="flex flex-col gap-4 text-sm text-gray-200">
                        ...
                        <div
                            ...
                            <svg class="text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="28"
                                height="28" fill="currentColor" viewBox="0 0 24 24">
                                <path
