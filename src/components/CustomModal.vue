<template>
    <div class="bg-white w-[350px] p-5 rounded-sm shadow-lg border border-gray-100">
        <div class="flex gap-4 mb-4">

            <div class="text-sm text-gray-600 cursor-pointer  space-y-1">
                <div class="flex gap-5">
                    <svg class=" text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="64"
                    ...
                    <p class="hover:scale-105 hover:duration-300 text-lg mt-5 ">Help Center</p>
                </div>
                <div class="flex gap-5">
                    <svg class=" text-gray-800" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="64"
                        height="64" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <p class="hover:scale-105 hover:duration-300 text-lg mt-5 ">Orders & Payment</p>
                </div>
                <div class="flex gap-5">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        aria-hidden="true" role="img" width="64" height="64" viewBox="0 0 24 24"
                    ...
                    <p class="hover:scale-105 hover:duration-300 text-lg mt-5">Shipping & Delivery</p>
                </div>
                <div class="flex gap-5">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                        aria-hidden="true" role="img" width="64" height="64" viewBox="0 0 24 24"
                    ...
                    <p class="hover:scale-105 hover:duration-300 text-lg mt-5">Returns & Funds</p>
                </div>
